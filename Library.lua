    ...
    function Window:CreateTab(TabName, Icon)
        ...
        function TabAPI:AddToggle(Config)
            ...
            ToggleButton.MouseLeave:Connect(function()
                Tween(ToggleFrame, {BackgroundColor3 = Theme.ElementBg}, 0.15)
            end)
        ...
        function TabAPI:AddButton(Config)
            ...
            Button.MouseButton1Click:Connect(function()
                ...
                wait(0.1)
                Tween(ButtonFrame, {BackgroundColor3 = Theme.ElementBg}, 0.1)
            ...
            Button.MouseLeave:Connect(function()
                Tween(ButtonFrame, {BackgroundColor3 = Theme.ElementBg}, 0.15)
            end)
        end
